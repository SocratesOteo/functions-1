...
exclaimThree = str => { console.log(str.toUpperCase(""))}

exclaimThree("It works")
...
bestMovie = (movieTitle) => {console.log(`${movieTitle} if the best movie ever!!`)}
...
function emailCheck(email){
  email = String(email).trim()
    if(email.includes("@")){
      ...
      console.log("must provide a vaild email address")
    }


}

emailCheck('apple@next.com')
